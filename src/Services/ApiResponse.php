...
namespace Johnvict\ApiResponse\Services;
...
trait ApiResponse {
	...
	*/
	public static function returnSuccess($data = null) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0000"], $data, $data == null ? 'Successfull' : null), 200);
	}
	...
	*/
	public static function returnSuccessLater($data) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0001"], $data), 200);
	}
	...
	*/
	public static function returnFailed($message = null) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0002"], null, $message), 200);
	}
	...
	*/
	public static function returnTooMany($errorMessage = null) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0003"], $errorMessage), 200);
	}
	...
	*/
	public static function returnUnkown($errorMessage = null) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0004"], $errorMessage), 200);
	}
	...
	*/
	public static function returnNotFound($message = null) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0005"], null, $message), 200);
	}
	...
	*/
	public static function returnProviderFailed($message = null) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0006"], null, $message), 200);
	}

	public static function returnInvalidUsernamePassword($data = null) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0007"], $data), 200);
	}
	public static function returnInvalidAccessKey($data = null) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0008"], $data), 200);
	}
	public static function returnNotPermitted($data = null) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0009"], $data), 200);
	}
	public static function returnServiceDown($data = null) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0098"], $data), 200);
	}
	public static function returnSystemFailure($data = null) {
		return response()->json(ApiResponse::formatResponse(ApiResponse::$statusCodes["0099"], $data), 200);
	}
